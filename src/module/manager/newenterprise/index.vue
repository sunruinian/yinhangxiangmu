<template>
  <div class="content-area" id="voucherApproving">
    ...
    <div class="content-body">
      <div class="long">
        <el-row>
          <el-col :span='24'>
            <el-form :inline="true" :model="searchData" class="stand-form " label-width="100px" >
                  <fieldset>
                    <el-form-item label="企业名称" label-width="93px">
                      <el-input v-model="searchData.no"  placeholder="请输入企业名称"></el-input>
                    </el-form-item>
                    <el-form-item label="机构名称" label-width="75px">
                      <el-input v-model="searchData.companyQstr"  placeholder="请输入机构名称"></el-input>
                    </el-form-item>
                    <el-form-item label="客户经理" label-width="75px" class="last-item">
                      <el-input v-model="searchData.companyQstr"  placeholder="客户经理姓名全称"></el-input>
                    </el-form-item>
        ...
        <el-row>
          <el-col :span='24' class="mt30 box-shadow radius-4 pl15 pr15 mb30 table-wrap">
            <el-table
              :data="tableData"
              stripe
              style="width: 100%">
