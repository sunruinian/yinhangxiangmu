...
<template>
  <div class="content-area">
    ...
    <div class="content-body" style='background: #fff;' v-if="hasData1 === 1 && hasData2 === 1">
        <div class="long" >
          <!-- v-if="hasData1 === 1 && hasData2 === 1" -->
            <el-row>
              <el-col :span='24' >
                ...
                <el-table
                  ...
                  <el-table-column
                    ...
                    <template scope="scope">
                      <el-tag type="gray" v-for='item in financingResult' :key="item.index" v-if='scope.row.financingStatus===item.value' >
                        {{item.label}}
                      </el-tag>
                    </template>
                  </el-table-column>
