                        ...
                        <table class="table-lr">
                            <tbody>
                              <tr>
                                  ...
                                  <td class="r" width="200"><span v-for='item in financingType' v-if='item.value === detail.financingType'>{{item.label}}</span></td>
                              </tr>
                              <tr>
                                  <td class="l">贷款方</td>
                                  <td class="r">{{detail.creditSideName}}</td>
                                  <td class="l">融资金额（元）</td>
                                  <td class="r">{{detail.financingAmount | moneyShow}}</td>
                              </tr>
                              <tr>
                                  <!-- <td class="l">融资比例</td>
                                  <td class="r">{{detail.financingRatio}}</td> -->
                                  <td class="l">融资状态</td>
                                  <td class="r"><span v-for='item in financingResult' v-if='item.value === detail.financingStatus'>{{item.label}}</span></td>
                              </tr>
                              <!-- <tr>
...
export default {
  ...
  data () {
    return {
      ...
      financingType: status.financingType,
