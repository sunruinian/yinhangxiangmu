<template>
  <div class="content-area" >
    ...
    <div class="content-body" style='background: #fff;'>
      ...
      <el-row class="pl20 mb15">
        <el-col>
          <el-button-group>
            <!-- <el-button type="primary" @click="createNum"> + 关联用户</el-button> -->
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template scope="scope">
                ...
                <el-button v-if='scope.row.status === 2 && detailAccess' @click='toInfo(scope.row.downstreamId)' type="text" size="small" style="color:#FB642A">基础信息</el-button>
                <span v-if='scope.row.status === 3'>
                  <el-button v-if='scope.row.originator && relevantAccess' @click='reRelevent(scope.row.downstreamId, scope.row.downstreamName)' type="text" size="small" style="color:#FB642A">重新关联</el-button>
            ...
            <!-- <el-table-column
              ...
              align="center">
              <template scope="scope" >
                <el-button @click='toInfo(scope.row.parentId)' type="text" size="small">基础信息</el-button>
              </template>
            </el-table-column> -->
          </el-table>
        </el-col>
...
import relevant from 'module/customer/upstream/relevant'
...
const base = {
  ...
  beforeMount () {
    this.getGrid()
    this.detailAccess = accessControl.checkAccess('/customer/upstream/detail')
  },
  methods: {
    getGrid () { // 获得表数据
    ...
    toInfo (id) {
      location.href = '#/customer/upstream/detail?id=' + id
    },
    createNum () {
      location.href = '#/customer/upstream/create'
    },
