        ...
        <div v-show='next===false'>
          ...
          <el-form id="formId" :model="formField" :rules="rules" ref="formField"  :inline="false"  class="unite-form "  action="" label-width="150px" >
              <fieldset>
                  ...
                  <el-row >
                    <el-col :span="11">
                      <el-form-item label="供应商名称" prop="companyName" label-width='110px'>
                          <el-input
              ...
              <fieldset>
                  ...
                  <el-row >
                    <el-col :span="11">
                      <el-form-item label="付款金额"  prop='value' label-width='110px'>
                        <el-input
                          placeholder="请输入付款金额"
                  ...
                  <el-row >
                    ...
                    <el-col :span="11">
                        <el-form-item label="付款类型" prop="paymentType" label-width="140px">
                  ...
                  <div class="group form-row ">
                      <div class="wrapper">
                        <el-button class="cancel" type="info" style="margin-right:30px" @click = "cancel">取消</el-button>
                        <el-button class="sure" :disabled="!checkedPromiss" type="info" size="medium" @click = "preview">预览</el-button>
                      </div>
                  </div>
              </fieldset>
          </el-form>
        ...
        <div v-if='next===true'>
          ...
          <div class="group form-row " style="margin:20px;text-align:center">
              <span class="wrapper center center-ie9">
                <el-button class="cancel"  type="info"  @click = "next=false">上一步</el-button>
                <el-button class="sure"  type="info"  @click = "redirect">确认</el-button>
              </span>
          </div>
        </div>
    </div>
...
import voucherService from 'common/api/voucher/common'
...
export default {
  ...
  methods: {
    preview: function () {
      ...
      this.$refs.formField.validate((valid) => {
        ...
        if (valid) {
          ...
          this.detail = detail
          this.scrollhang()
          this.detail.cashTime = dateTools.stringToDate(this.detail.cashTime, 'YYYY-MM-DD')
    ...
    supplier () {
      var self = this
      coreApi.supplierList.remote({value: ''}, (data) => {
      ...
      coreApi.subAccountList.remote('', (data) => {
        ...
        Array.map(data, function (item) {
          var o = item.issuer
          o.name = !o.name ? o.bankName : o.name
          o.payAccountId = item.id + ''
          o.no = item.no
          // var num1 = item.no.substring(item.no.length-5,item.no.length-1);
          // o.value = o.name + ' （*********' + item.no.substring(item.no.length - 5, item.no.length - 1) + '）'
